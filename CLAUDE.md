...
- **The homepage is one stage, and its two objects are the app's own mockups (2026-09-16).**
  ...
  phone is a cropped screenshot of the conversation (bar, thread, composer; no bezel, status bar or
  home bar; the transcript is bottom-aligned, so it only shows fewer bubbles) so it can stand
  nearly full width and stay readable without a whole phone reading as stubby, Ember stands beside the computer
