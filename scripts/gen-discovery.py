...
tell the agent a job in plain words, and it does that job on the schedule you set. It works
on your computer and answers on your phone. Otian AI is the two-person company that makes
it."""
...
QUESTIONS = [
    ...
    ("What is an add-on?",
     f"One job you hand the agent. The public catalog has {len(json.load(open(os.path.join(ROOT, 'data/public-catalog.json'), encoding='utf-8'))['items'])} add-ons, "
    ...
    ("What can it connect to?",
     "49 apps and services: 5 chat apps, 7 AI companies, and 37 accounts and devices. Connections use your accounts, local files or devices, and only what you choose to connect."),
